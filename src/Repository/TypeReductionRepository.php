...
/**
 * @extends ServiceEntityRepository<TypeReduction>
 *
...
class TypeReductionRepository extends ServiceEntityRepository
{
    ...
    public function add(TypeReduction $entity, bool $flush = false): void
    {
    ...
    public function remove(TypeReduction $entity, bool $flush = false): void
    {
