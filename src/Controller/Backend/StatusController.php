...
class StatusController extends AbstractController
{
    ...
    {
        return $this->render('backend/status/index.html.twig', [
    ...
    public function new(Request $request, StatusRepository $statusRepository): Response
    {
        ...
        return $this->renderForm('backend/status/new.html.twig', [
            'status' => $status,
            'form' => $form,
        ]);
    }
    ...
    public function edit(Request $request, Status $status, StatusRepository $statusRepository): Response
    {
        ...
        return $this->renderForm('backend/status/edit.html.twig', [
            'status' => $status,
            'form' => $form,
        ]);
    }

    #[Route('/{id}/delete', name: 'app_status_delete', methods: ['GET'])]
